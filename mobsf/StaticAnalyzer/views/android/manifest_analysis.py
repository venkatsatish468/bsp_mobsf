...
def manifest_data(mfxml):
    ...
    try:
        ...
        declared_permissions = mfxml.getElementsByTagName('permission')
        protected_broadcasts_tag=mfxml.getElementsByTagName('protected-broadcast')
        ...
        for dec_perm in declared_permissions:
            prm_name=dec_perm.getAttribute('android:name')
            prm_level=dec_perm.getAttribute('android:protectionLevel')
            dec_perm_dic[prm_name]=[prm_name,prm_level]

        for broadcasts in protected_broadcasts_tag:
            protected_broadcasts_list.append(broadcasts.getAttribute('android:name'))
        ...
        man_data_dic = {
            'declared_permissions': dec_perm_dic,
            'services': svc,
            'activities': act,
            'receivers': brd,
            'providers': cnp,
            'libraries': lib,
            'categories': cat,
            'protected_broadcasts':protected_broadcasts_list,
            'perm': dvm_perm,
            'packagename': package,
